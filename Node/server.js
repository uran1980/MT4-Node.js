	...
	.createServer(function onRequest(request, response) {
		...
		request.addListener('end', function() {
			...
			if (ms.toString() != '') {
				...
				// Here you can have the code to do what you want it to do.
				// You can also use cluster to run a multithreaded app.
				// Or connect to a DB or connect to external web services and collect data, etc
